...
public static partial class SwipeItemsExtension
{
    ...
    public static T ModeFmg<T>(this T self, Func<PropertyContext<SwipeMode>, IPropertyBuilder<SwipeMode>> configure)
        where T : SwipeItems
    {
    ...
    public static SettersContext<T> ModeFmg<T>(this SettersContext<T> self,
        SwipeMode mode)
        where T : SwipeItems
    {
    ...
    public static SettersContext<T> ModeFmg<T>(this SettersContext<T> self, Func<PropertySettersContext<SwipeMode>, IPropertySettersBuilder<SwipeMode>> configure)
        where T : SwipeItems
    {
    ...
    public static T SwipeBehaviorOnInvokedFmg<T>(this T self,
    ...
    public static T SwipeBehaviorOnInvokedFmg<T>(this T self, Func<PropertyContext<SwipeBehaviorOnInvoked>, IPropertyBuilder<SwipeBehaviorOnInvoked>> configure)
        where T : SwipeItems
    {
    ...
    public static SettersContext<T> SwipeBehaviorOnInvokedFmg<T>(this SettersContext<T> self,
        SwipeBehaviorOnInvoked swipeBehaviorOnInvoked)
        where T : SwipeItems
    {
    ...
    public static SettersContext<T> SwipeBehaviorOnInvokedFmg<T>(this SettersContext<T> self, Func<PropertySettersContext<SwipeBehaviorOnInvoked>, IPropertySettersBuilder<SwipeBehaviorOnInvoked>> configure)
        where T : SwipeItems
    {
