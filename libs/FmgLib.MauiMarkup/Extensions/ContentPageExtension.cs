...
public static partial class ContentPageExtension
{
    ...
    public static T ContentFmg<T>(this T self, Func<PropertyContext<View>, IPropertyBuilder<View>> configure) where T : ContentPage
    {
    ...
    public static SettersContext<T> ContentFmg<T>(this SettersContext<T> self, View content) where T : ContentPage
    {
    ...
    public static SettersContext<T> ContentFmg<T>(this SettersContext<T> self, Func<PropertySettersContext<View>, IPropertySettersBuilder<View>> configure) where T : ContentPage
    {
