...
namespace Game2048Maui.Data
{
    ...
    public class ConfettiConfig : BindableObject
    {
        ...
        public static ObservableCollection<string> Shapes { get; } = new ObservableCollection<string>
    {
        "Square",
        "Circle",
        "Line",
        ...
        public static ObservableCollection<Color> Colors { get; } = new ObservableCollection<Color>
    {
        ...
        public static IEnumerable<IEnumerable<SKConfettiShape>> GetShapes(IEnumerable<string> shapes)
        {
