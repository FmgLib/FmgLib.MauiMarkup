...
{
    public static TView FlexAlignSelf<TView>(this TView view, FlexAlignSelf value) where TView : View
    {
        FlexLayout.SetAlignSelf((BindableObject)view, value);
        return view;
    }

    public static TView FlexBasis<TView>(this TView view, FlexBasis value) where TView : View
    {
        FlexLayout.SetBasis((BindableObject)view, value);
        return view;
    }

    public static TView FlexOrder<TView>(this TView view, int value) where TView : View
    {
        FlexLayout.SetOrder((BindableObject)view, value);
        return view;
    }

    public static TView FlexGrow<TView>(this TView view, float value) where TView : View
    {
        FlexLayout.SetGrow((BindableObject)view, value);
        return view;
    }

    public static TView FlexShrink<TView>(this TView view, float value) where TView : View
    {
