...
public static partial class SwitchExtension
{
    ...
    public static T OnColor<T>(this T self, Func<PropertyContext<Color>, IPropertyBuilder<Color>> configure)
        where T : Switch
    {
    ...
    public static SettersContext<T> OnColor<T>(this SettersContext<T> self, Func<PropertySettersContext<Color>, IPropertySettersBuilder<Color>> configure)
        where T : Switch
    {
    ...
    public static Task<bool> AnimateOnColorTo<T>(this T self, Color value, uint length = 250, Easing? easing = null)
        where T : Switch
    {
    ...
    public static T OnToggled<T>(this T self, EventHandler<ToggledEventArgs> handler)
        where T : Switch
    {
    ...
    public static T OnToggled<T>(this T self, Action<T> action)
        where T : Switch
    {
