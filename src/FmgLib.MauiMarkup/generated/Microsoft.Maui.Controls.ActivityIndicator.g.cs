...
public static partial class ActivityIndicatorExtension
{
    ...
    public static T Color<T>(this T self, Func<PropertyContext<T, Microsoft.Maui.Graphics.Color>, IPropertyBuilder<T, Microsoft.Maui.Graphics.Color>> configure)
        where T : Microsoft.Maui.Controls.ActivityIndicator
    {
        var context = new PropertyContext<T, Microsoft.Maui.Graphics.Color>(self, Microsoft.Maui.Controls.ActivityIndicator.ColorProperty);
    ...
    public static SettersContext<T> Color<T>(this SettersContext<T> self, Func<PropertySettersContext<T, Microsoft.Maui.Graphics.Color>, IPropertySettersBuilder<T, Microsoft.Maui.Graphics.Color>> configure)
        where T : Microsoft.Maui.Controls.ActivityIndicator
    {
        var context = new PropertySettersContext<T, Microsoft.Maui.Graphics.Color>(self.XamlSetters, Microsoft.Maui.Controls.ActivityIndicator.ColorProperty);
        configure(context).Build();
        return self;
    }
        ...
        where T : Microsoft.Maui.Controls.ActivityIndicator
    {
        ...
        var callback = (Microsoft.Maui.Graphics.Color actValue) => { self.SetValue(Microsoft.Maui.Controls.ActivityIndicator.ColorProperty, actValue); };
    ...
    public static T IsRunning<T>(this T self, Func<PropertyContext<T, bool>, IPropertyBuilder<T, bool>> configure)
        where T : Microsoft.Maui.Controls.ActivityIndicator
    {
        var context = new PropertyContext<T, bool>(self, Microsoft.Maui.Controls.ActivityIndicator.IsRunningProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> IsRunning<T>(this SettersContext<T> self, Func<PropertySettersContext<T, bool>, IPropertySettersBuilder<T, bool>> configure)
        where T : Microsoft.Maui.Controls.ActivityIndicator
    {
        var context = new PropertySettersContext<T, bool>(self.XamlSetters, Microsoft.Maui.Controls.ActivityIndicator.IsRunningProperty);
        configure(context).Build();
        return self;
    }
