...
public static partial class ElementExtension
{
    ...
    public static T Effects<T>(this T self,
        Func<Microsoft.Maui.Controls.Effect[]> configure)
        where T : Microsoft.Maui.Controls.Element
    {
    ...
    public static T AutomationId<T>(this T self, Func<PropertyContext<T, string>, IPropertyBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.Element
    {
        var context = new PropertyContext<T, string>(self, Microsoft.Maui.Controls.Element.AutomationIdProperty);
    ...
    public static SettersContext<T> AutomationId<T>(this SettersContext<T> self, Func<PropertySettersContext<T, string>, IPropertySettersBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.Element
    {
        var context = new PropertySettersContext<T, string>(self.XamlSetters, Microsoft.Maui.Controls.Element.AutomationIdProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T ClassId<T>(this T self, Func<PropertyContext<T, string>, IPropertyBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.Element
    {
        var context = new PropertyContext<T, string>(self, Microsoft.Maui.Controls.Element.ClassIdProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> ClassId<T>(this SettersContext<T> self, Func<PropertySettersContext<T, string>, IPropertySettersBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.Element
    {
        var context = new PropertySettersContext<T, string>(self.XamlSetters, Microsoft.Maui.Controls.Element.ClassIdProperty);
        configure(context).Build();
        return self;
    }
