...
public static partial class ShapesRotateTransformExtension
{
    ...
    public static T Angle<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.RotateTransform.AngleProperty);
    ...
    public static SettersContext<T> Angle<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.RotateTransform.AngleProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T CenterX<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterXProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> CenterX<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterXProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T CenterY<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterYProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> CenterY<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.RotateTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.RotateTransform.CenterYProperty);
        configure(context).Build();
        return self;
    }
