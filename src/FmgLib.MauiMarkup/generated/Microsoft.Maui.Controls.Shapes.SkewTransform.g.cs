...
public static partial class ShapesSkewTransformExtension
{
    ...
    public static T AngleX<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.SkewTransform.AngleXProperty);
    ...
    public static SettersContext<T> AngleX<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.SkewTransform.AngleXProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T AngleY<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.SkewTransform.AngleYProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> AngleY<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.SkewTransform.AngleYProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T CenterX<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.SkewTransform.CenterXProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> CenterX<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.SkewTransform.CenterXProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T CenterY<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.Shapes.SkewTransform.CenterYProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> CenterY<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.Shapes.SkewTransform
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.Shapes.SkewTransform.CenterYProperty);
        configure(context).Build();
        return self;
    }
