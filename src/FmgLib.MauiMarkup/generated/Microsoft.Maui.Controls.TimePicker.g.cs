...
public static partial class TimePickerExtension
{
    ...
    public static T CharacterSpacing<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.TimePicker.CharacterSpacingProperty);
    ...
    public static SettersContext<T> CharacterSpacing<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.CharacterSpacingProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T FontAttributes<T>(this T self, Func<PropertyContext<T, Microsoft.Maui.Controls.FontAttributes>, IPropertyBuilder<T, Microsoft.Maui.Controls.FontAttributes>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, Microsoft.Maui.Controls.FontAttributes>(self, Microsoft.Maui.Controls.TimePicker.FontAttributesProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> FontAttributes<T>(this SettersContext<T> self, Func<PropertySettersContext<T, Microsoft.Maui.Controls.FontAttributes>, IPropertySettersBuilder<T, Microsoft.Maui.Controls.FontAttributes>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, Microsoft.Maui.Controls.FontAttributes>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.FontAttributesProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T FontAutoScalingEnabled<T>(this T self, Func<PropertyContext<T, bool>, IPropertyBuilder<T, bool>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, bool>(self, Microsoft.Maui.Controls.TimePicker.FontAutoScalingEnabledProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> FontAutoScalingEnabled<T>(this SettersContext<T> self, Func<PropertySettersContext<T, bool>, IPropertySettersBuilder<T, bool>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, bool>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.FontAutoScalingEnabledProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T FontFamily<T>(this T self, Func<PropertyContext<T, string>, IPropertyBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, string>(self, Microsoft.Maui.Controls.TimePicker.FontFamilyProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> FontFamily<T>(this SettersContext<T> self, Func<PropertySettersContext<T, string>, IPropertySettersBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, string>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.FontFamilyProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T FontSize<T>(this T self, Func<PropertyContext<T, double>, IPropertyBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, double>(self, Microsoft.Maui.Controls.TimePicker.FontSizeProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> FontSize<T>(this SettersContext<T> self, Func<PropertySettersContext<T, double>, IPropertySettersBuilder<T, double>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, double>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.FontSizeProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T Format<T>(this T self, Func<PropertyContext<T, string>, IPropertyBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, string>(self, Microsoft.Maui.Controls.TimePicker.FormatProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> Format<T>(this SettersContext<T> self, Func<PropertySettersContext<T, string>, IPropertySettersBuilder<T, string>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, string>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.FormatProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T TextColor<T>(this T self, Func<PropertyContext<T, Microsoft.Maui.Graphics.Color>, IPropertyBuilder<T, Microsoft.Maui.Graphics.Color>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, Microsoft.Maui.Graphics.Color>(self, Microsoft.Maui.Controls.TimePicker.TextColorProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> TextColor<T>(this SettersContext<T> self, Func<PropertySettersContext<T, Microsoft.Maui.Graphics.Color>, IPropertySettersBuilder<T, Microsoft.Maui.Graphics.Color>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, Microsoft.Maui.Graphics.Color>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.TextColorProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static T Time<T>(this T self, Func<PropertyContext<T, System.TimeSpan>, IPropertyBuilder<T, System.TimeSpan>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertyContext<T, System.TimeSpan>(self, Microsoft.Maui.Controls.TimePicker.TimeProperty);
        configure(context).Build();
        return self;
    }
    ...
    public static SettersContext<T> Time<T>(this SettersContext<T> self, Func<PropertySettersContext<T, System.TimeSpan>, IPropertySettersBuilder<T, System.TimeSpan>> configure)
        where T : Microsoft.Maui.Controls.TimePicker
    {
        var context = new PropertySettersContext<T, System.TimeSpan>(self.XamlSetters, Microsoft.Maui.Controls.TimePicker.TimeProperty);
        configure(context).Build();
        return self;
    }
